...
export default function DateRangeSelector({ startDate, endDate, onDateRangeChange }: DateRangeSelectorProps) {
  ...
  return (
    <div className="bg-white dark:bg-white/[0.04] border border-gray-200 dark:border-white/[0.08] rounded-2xl p-6 print:border-0 print:p-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2 bg-white dark:bg-white/[0.06] border border-gray-300 dark:border-white/[0.1] text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-[#4A8FA8] focus:border-transparent"
          />
        </div>
        <div>
          <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
