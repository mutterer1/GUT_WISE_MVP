...
export default function SymptomsLog() {
  ...
  formData.triggers.includes(trigger)
    ? 'border-teal-500 bg-white text-gray-900 shadow-md dark:border-teal-300 bg-teal-50 dark:text-gray-900 dark:hover:border-teal-300 bg-teal-50 text-gray-900 '
