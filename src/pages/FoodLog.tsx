                  ...
                  <button
                    ...
                    className={`rounded-lg border-2 p-3 text-sm transition-all ${
                      formData.tags.includes(tag)
                        ? 'border-teal-500 bg-teal-50 text-gray-900 shadow-md dark:border-teal-500 bg-teal-50 text-gray-900 dark:hover:border-dark-border text-gray-900'
              ...
              {formData.tags.length > 0 && (
                <div className="mt-3 flex flex-wrap gap-2">
                  {formData.tags.map((tag) => (
                    <span
                      key={tag}
                      className="inline-flex items-center rounded-full bg-teal-300 px-2 py-1 text-xs text-teal-700"
                    >
