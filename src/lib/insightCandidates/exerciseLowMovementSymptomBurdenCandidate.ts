...
const INSIGHT_KEY = 'exercise_low_movement_same_day_symptom_burden';

function hasExerciseOrMovementData(day: UserDailyFeatures): boolean {
  return (
...
function isLowMovementDay(day: UserDailyFeatures): boolean {
...
export function analyzeExerciseLowMovementSymptomBurdenCandidate(
  ...
  const eligibleDays = features.filter(hasExerciseOrMovementData);
  ...
  return {
    ...
    category: 'exercise',
    subtype: 'low_movement_symptom_burden',
